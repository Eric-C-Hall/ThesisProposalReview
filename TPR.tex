...
\subsubsection{Viterbi's original paper }

\subsubsection{Viterbi algorithm for error correction}

\subsection{(unkown quality, google search) Pragmatic Formal Verification of Sequential Error
...
\subsection{(cited by Aman Kumar, book) Soft errors in Modern Electronic Systems}

\subsection{(cited by Aman Kumar, book) Dependability in electronic systems - Mitigation of Hardware Failures, Soft Errors, and Electro-Magnetic Disturbances}
...
\subsection{(cited by Aman Kumar) Error correcting code analysis for cache memory high reliability and performance}

Low relevance

\subsection{(cited by Aman Kumar) Formal Verification, An Essential Toolkit for Modern VLSI Design} 
